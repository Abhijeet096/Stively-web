...
/**
 * A plain form posting to the googleSignIn Server Action rather than a
 * client "use client" button calling next-auth/react's `signIn` - this
 * project doesn't wrap the app in a `<SessionProvider>` (kept out
 * deliberately, see src/components/shared/navbar.tsx's server-side session
